const translations = {
  ...
  tour: {
    onboardingModal: {
      title: {
        1: '多线程对话：可以基于任意分支进行连续追问，便于发散性思考',
        2: '知识库整合：导入任意外部资源到知识库，按需加入到画布中 ',
        3: '选择上下文：画布任意节点可添加为上下文，进行更有针对性的提问，获得更理想的答案',
        4: '文档输出：选择「AI 写作」技能，可以自动为你输出一篇文档，后续可以自由修改',
        5: 'AI 编辑：在文档中划线后可以让 AI 按照你的需求进行修改和润色',
      },
      description: {
        1: 'Refly 是一个基于「自由画布」理念构建的 AI 原生内容创作平台，通过多线程对话、知识库整合、上下文记忆、智能搜索与可见即可得的 AI 文档编辑器，为用户提供从创意萌发到成品内容的一站式解决方案',
        2: '请补充xxxxx',
        3: '请补充xxxxx',
        4: '请补充xxxxx',
        5: '请补充xxxxx',
