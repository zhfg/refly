  ...
  },
  {
    ...
    link: {
      ...
      close(state, mark, parent, index) {
        ...
        const href = typeof mark.attrs.href === 'string' ? mark.attrs.href : String(mark.attrs.href);
        const title = typeof mark.attrs.title === 'string' ? mark.attrs.title : String(mark.attrs.title);
