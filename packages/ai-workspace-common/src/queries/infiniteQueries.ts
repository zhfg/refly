...
import { listCanvases, listDocuments, listLabelClasses, listLabelInstances, listResources, listSkillInstances, listSkillTriggers } from "../requests/services.gen";
import { ListCanvasesData, ListCanvasesError, ListDocumentsData, ListDocumentsError, ListLabelClassesData, ListLabelClassesError, ListLabelInstancesData, ListLabelInstancesError, ListResourcesData, ListResourcesError, ListSkillInstancesData, ListSkillInstancesError, ListSkillTriggersData, ListSkillTriggersError } from "../requests/types.gen";
