 ...
 * Get auth config
 */
export const getAuthConfig = <ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) => { return (options?.client ?? client).get<GetAuthConfigResponse, GetAuthConfigError, ThrowOnError>({
    ...options,
    url: '/auth/config'
}); };
 ...
 * Refresh token
 */
export const refreshToken = <ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) => { return (options?.client ?? client).post<RefreshTokenResponse, RefreshTokenError, ThrowOnError>({
    ...options,
 ...
 * Sign up with email
 */
export const emailSignup = <ThrowOnError extends boolean = false>(options: Options<EmailSignupData2, ThrowOnError>) => { return (options?.client ?? client).post<EmailSignupResponse2, EmailSignupError, ThrowOnError>({
    ...options,
 ...
 * Login with email
 */
export const emailLogin = <ThrowOnError extends boolean = false>(options: Options<EmailLoginData2, ThrowOnError>) => { return (options?.client ?? client).post<EmailLoginResponse2, EmailLoginError, ThrowOnError>({
    ...options,
 ...
 */
export const createVerification = <ThrowOnError extends boolean = false>(options: Options<CreateVerificationData2, ThrowOnError>) => { return (options?.client ?? client).post<CreateVerificationResponse2, CreateVerificationError, ThrowOnError>({
    ...options,
 ...
 * Resend verification
 */
export const resendVerification = <ThrowOnError extends boolean = false>(options: Options<ResendVerificationData, ThrowOnError>) => { return (options?.client ?? client).post<ResendVerificationResponse, ResendVerificationError, ThrowOnError>({
    ...options,
 ...
 * Get collab token
 */
export const getCollabToken = <ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) => { return (options?.client ?? client).get<GetCollabTokenResponse2, GetCollabTokenError, ThrowOnError>({
    ...options,
    url: '/collab/getToken'
}); };
 ...
 */
export const updateCanvas = <ThrowOnError extends boolean = false>(options: Options<UpdateCanvasData, ThrowOnError>) => { return (options?.client ?? client).post<UpdateCanvasResponse, UpdateCanvasError, ThrowOnError>({
    ...options,
    url: '/canvas/update'
}); };
 ...
 * Get subscription plans
 */
export const getSubscriptionPlans = <ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) => { return (options?.client ?? client).get<GetSubscriptionPlansResponse2, GetSubscriptionPlansError, ThrowOnError>({
    ...options,
