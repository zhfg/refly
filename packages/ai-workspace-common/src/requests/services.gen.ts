 ...
 * Sign up with email
 */
export const emailSignup = <ThrowOnError extends boolean = false>(options: Options<EmailSignupData, ThrowOnError>) => { return (options?.client ?? client).post<EmailSignupResponse2, EmailSignupError, ThrowOnError>({
    ...options,
 ...
 * Login with email
 */
export const emailLogin = <ThrowOnError extends boolean = false>(options: Options<EmailLoginData, ThrowOnError>) => { return (options?.client ?? client).post<EmailLoginResponse2, EmailLoginError, ThrowOnError>({
    ...options,
 ...
 */
export const createVerification = <ThrowOnError extends boolean = false>(options: Options<CreateVerificationData, ThrowOnError>) => { return (options?.client ?? client).post<CreateVerificationResponse2, CreateVerificationError, ThrowOnError>({
    ...options,
 ...
 */
export const checkVerification = <ThrowOnError extends boolean = false>(options: Options<CheckVerificationData, ThrowOnError>) => { return (options?.client ?? client).post<CheckVerificationResponse2, CheckVerificationError, ThrowOnError>({
    ...options,
