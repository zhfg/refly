    ...
    return [
      allSelectedNodesAreSkill
        ...
        : {
            ...
            hoverContent: {
              ...
              videoUrl: 'https://static.refly.ai/onboarding/selection-node-action/selection-nodeAction-askAI.mp4',
            },
          },
      hasSkill
        ? {
      ...
      { key: 'divider-1', type: 'divider' } as MenuItem,
      {
        ...
        hoverContent: {
          ...
          videoUrl: 'https://static.refly.ai/onboarding/selection-node-action/selection-nodeAction-addToContext.mp4',
        },
      },
      { key: 'divider-2', type: 'divider' } as MenuItem,
      {
        ...
        hoverContent: {
          ...
          videoUrl: 'https://static.refly.ai/onboarding/selection-node-action/selection-nodeAction-group.mp4',
        },
      },
