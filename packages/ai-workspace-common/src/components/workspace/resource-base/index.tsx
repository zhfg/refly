...
export const ResourceBase = () => {
  ...
  const getResourceList = async () => {
    const res: any = await getClient().listResources({
      query: {
  ...
  return (
    ...
    {
      resourceList.length === 0 ? <EmptyDigestStatus /> :
        ...
        >
          ...
          <div className="h-40 overflow-hidden">
            <div className="resource-url flex mt-3 mb-1">
              ...
              <a className="resource-url-text ml-2 hover:text-blue-600" href="#" onClick={(e) => {
                e.stopPropagation();
          ...
          <div className="flex items-center justify-between mt-6">
            <div className="text-xs text-black/40">
              {
                time(item.updatedAt, language as LOCALE).utc().fromNow()
              }
            </div>
            <div>
              {/* TODO: 添加事件 */}
