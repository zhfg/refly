    ...
    <span className="inline-block w-4">
      <Popover>
        ...
        <PopoverContent
          ...
          className="flex max-w-screen-md flex-col gap-2 text-xs shadow-transparent ring-4 ring-zinc-50">
          <div className="overflow-hidden text-ellipsis whitespace-nowrap font-medium">
            {source.metadata?.title}
          </div>
          <div className="flex gap-4">
            <div className="flex-1">
              <div className="line-clamp-4 break-words text-zinc-500">
                {source.pageContent}
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            <div className="flex-1 overflow-hidden">
              <div className="overflow-hidden text-ellipsis whitespace-nowrap text-blue-500">
                <a
                  title={source.metadata?.title}
