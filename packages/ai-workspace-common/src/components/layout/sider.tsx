        ...
        >
          <div className="sider-header">
            ...
            <MenuItem key="Workspace" className="custom-menu-item">
              ...
              <span className="sider-menu-title">{t('loggedHomePage.siderMenu.homePage')}</span>
            </MenuItem>
          ...
          <div className="sider-footer">
            <MenuItem key="GetHelp" className="custom-menu-item">
              ...
              <span className="sider-menu-title">{t('loggedHomePage.siderMenu.getHelp')}</span>
            </MenuItem>
            {!!userStore.userProfile?.uid && (
              <>
                <Divider style={{ margin: '8px 0' }} />
                <MenuItem key="Settings" className="menu-setting-container setting-menu-item">
                  <div
                  ...
                  <div>
                    <span className="setting-language-icon" style={{ display: 'inline-block', marginRight: '8px' }}>
                      <UILocaleList>
                        <IconLanguage
                          style={{
                            fontSize: 20,
            ...
            <MenuItem key="DownloadExtension" className="custom-menu-item">
              ...
              <span className="sider-menu-title">{t('loggedHomePage.siderMenu.download')}</span>
            </MenuItem>
          </div>
        </Menu>
      </div>
