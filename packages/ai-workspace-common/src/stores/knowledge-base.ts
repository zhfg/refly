...
export const useKnowledgeBaseStore = create<KnowledgeBaseState>()(
  devtools(set => ({
    ...
    updateTempConvResources: (tempConvResources: Resource[]) =>
    ...
    // skill
    setSkillState: (newState: SkillState) =>
      set(state => ({ ...state, skillState: newState })),
    ...
    // notes
    updateEditor: (editor: EditorInstance) =>
      set(state => ({ ...state, editor })),
    updateNoteServerStatus: (status: NoteServerStatus) =>
      set(state => ({ ...state, noteServerStatus: status })),
    updateNoteSaveStatus: (status: NoteSaveStatus) =>
      set(state => ({ ...state, noteSaveStatus: status })),
    updateNoteCharsCount: (count: number) =>
      set(state => ({ ...state, noteCharsCount: count })),
  })),
)
