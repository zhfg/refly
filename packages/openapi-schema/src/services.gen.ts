...
export const getResourceDetail = <ThrowOnError extends boolean = false>(
  ...
  return (options?.client ?? client).get<GetResourceDetailResponse2, GetResourceDetailError, ThrowOnError>({
    ...options,
...
export const updateResource = <ThrowOnError extends boolean = false>(
  ...
  return (options?.client ?? client).post<UpdateResourceResponse, UpdateResourceError, ThrowOnError>({
    ...options,
...
export const batchCreateResource = <ThrowOnError extends boolean = false>(
  ...
  return (options?.client ?? client).post<BatchCreateResourceResponse2, BatchCreateResourceError, ThrowOnError>({
    ...options,
...
export const reindexResource = <ThrowOnError extends boolean = false>(
  ...
  return (options?.client ?? client).post<ReindexResourceResponse2, ReindexResourceError, ThrowOnError>({
    ...options,
...
export const deleteResource = <ThrowOnError extends boolean = false>(
  ...
  return (options?.client ?? client).post<DeleteResourceResponse, DeleteResourceError, ThrowOnError>({
    ...options,
...
export const getDocumentDetail = <ThrowOnError extends boolean = false>(
  ...
  return (options?.client ?? client).get<GetDocumentDetailResponse2, GetDocumentDetailError, ThrowOnError>({
    ...options,
...
export const updateDocument = <ThrowOnError extends boolean = false>(
  ...
  return (options?.client ?? client).post<UpdateDocumentResponse, UpdateDocumentError, ThrowOnError>({
    ...options,
...
export const deleteDocument = <ThrowOnError extends boolean = false>(
  ...
  return (options?.client ?? client).post<DeleteDocumentResponse, DeleteDocumentError, ThrowOnError>({
    ...options,
...
export const batchUpdateDocument = <ThrowOnError extends boolean = false>(
  ...
  return (options?.client ?? client).post<BatchUpdateDocumentResponse, BatchUpdateDocumentError, ThrowOnError>({
    ...options,
...
export const queryReferences = <ThrowOnError extends boolean = false>(
  ...
  return (options?.client ?? client).post<QueryReferencesResponse2, QueryReferencesError, ThrowOnError>({
    ...options,
...
export const deleteReferences = <ThrowOnError extends boolean = false>(
  ...
  return (options?.client ?? client).post<DeleteReferencesResponse, DeleteReferencesError, ThrowOnError>({
    ...options,
 ...
 */
export const deleteShare = <ThrowOnError extends boolean = false>(options: Options<DeleteShareData, ThrowOnError>) => {
...
export const getShareContent = <ThrowOnError extends boolean = false>(
  ...
  return (options?.client ?? client).get<GetShareContentResponse2, GetShareContentError, ThrowOnError>({
    ...options,
    url: '/share/content',
  });
};
...
export const listLabelClasses = <ThrowOnError extends boolean = false>(
  ...
  return (options?.client ?? client).get<ListLabelClassesResponse2, ListLabelClassesError, ThrowOnError>({
    ...options,
...
export const createLabelClass = <ThrowOnError extends boolean = false>(
  ...
  return (options?.client ?? client).post<CreateLabelClassResponse, CreateLabelClassError, ThrowOnError>({
    ...options,
    url: '/label/class/new',
  });
};
...
export const updateLabelClass = <ThrowOnError extends boolean = false>(
  ...
  return (options?.client ?? client).post<UpdateLabelClassResponse, UpdateLabelClassError, ThrowOnError>({
    ...options,
...
export const deleteLabelClass = <ThrowOnError extends boolean = false>(
  ...
  return (options?.client ?? client).post<DeleteLabelClassResponse, DeleteLabelClassError, ThrowOnError>({
    ...options,
...
export const listLabelInstances = <ThrowOnError extends boolean = false>(
  ...
  return (options?.client ?? client).get<ListLabelInstancesResponse2, ListLabelInstancesError, ThrowOnError>({
    ...options,
...
export const createLabelInstance = <ThrowOnError extends boolean = false>(
  ...
  return (options?.client ?? client).post<CreateLabelInstanceResponse, CreateLabelInstanceError, ThrowOnError>({
    ...options,
...
export const updateLabelInstance = <ThrowOnError extends boolean = false>(
  ...
  return (options?.client ?? client).post<UpdateLabelInstanceResponse, UpdateLabelInstanceError, ThrowOnError>({
    ...options,
...
export const deleteLabelInstance = <ThrowOnError extends boolean = false>(
  ...
  return (options?.client ?? client).post<DeleteLabelInstanceResponse, DeleteLabelInstanceError, ThrowOnError>({
    ...options,
 ...
 * List all actions
 */
export const listActions = <ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) => {
...
export const streamInvokeAction = <ThrowOnError extends boolean = false>(
  ...
  return (options?.client ?? client).post<StreamInvokeActionResponse, StreamInvokeActionError, ThrowOnError>({
    ...options,
...
export const getActionResult = <ThrowOnError extends boolean = false>(
  ...
  return (options?.client ?? client).get<GetActionResultResponse2, GetActionResultError, ThrowOnError>({
    ...options,
    url: '/action/result',
  });
};
 ...
 * List all skills
 */
export const listSkills = <ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) => {
 ...
 * Invoke a skill
 */
export const invokeSkill = <ThrowOnError extends boolean = false>(options: Options<InvokeSkillData, ThrowOnError>) => {
...
export const streamInvokeSkill = <ThrowOnError extends boolean = false>(
  ...
  return (options?.client ?? client).post<StreamInvokeSkillResponse, StreamInvokeSkillError, ThrowOnError>({
    ...options,
...
export const listSkillInstances = <ThrowOnError extends boolean = false>(
  ...
  return (options?.client ?? client).get<ListSkillInstancesResponse, ListSkillInstancesError, ThrowOnError>({
    ...options,
...
export const createSkillInstance = <ThrowOnError extends boolean = false>(
  ...
  return (options?.client ?? client).post<CreateSkillInstanceResponse2, CreateSkillInstanceError, ThrowOnError>({
    ...options,
...
export const updateSkillInstance = <ThrowOnError extends boolean = false>(
  ...
  return (options?.client ?? client).post<UpdateSkillInstanceResponse2, UpdateSkillInstanceError, ThrowOnError>({
    ...options,
...
export const pinSkillInstance = <ThrowOnError extends boolean = false>(
  ...
  return (options?.client ?? client).post<PinSkillInstanceResponse, PinSkillInstanceError, ThrowOnError>({
    ...options,
...
export const unpinSkillInstance = <ThrowOnError extends boolean = false>(
  ...
  return (options?.client ?? client).post<UnpinSkillInstanceResponse, UnpinSkillInstanceError, ThrowOnError>({
    ...options,
...
export const deleteSkillInstance = <ThrowOnError extends boolean = false>(
  ...
  return (options?.client ?? client).post<DeleteSkillInstanceResponse, DeleteSkillInstanceError, ThrowOnError>({
    ...options,
...
export const listSkillTriggers = <ThrowOnError extends boolean = false>(
  ...
  return (options?.client ?? client).get<ListSkillTriggersResponse, ListSkillTriggersError, ThrowOnError>({
    ...options,
...
export const createSkillTrigger = <ThrowOnError extends boolean = false>(
  ...
  return (options?.client ?? client).post<CreateSkillTriggerResponse2, CreateSkillTriggerError, ThrowOnError>({
    ...options,
...
export const updateSkillTrigger = <ThrowOnError extends boolean = false>(
  ...
  return (options?.client ?? client).post<UpdateSkillTriggerResponse2, UpdateSkillTriggerError, ThrowOnError>({
    ...options,
...
export const deleteSkillTrigger = <ThrowOnError extends boolean = false>(
  ...
  return (options?.client ?? client).post<DeleteSkillTriggerResponse, DeleteSkillTriggerError, ThrowOnError>({
    ...options,
...
export const checkSettingsField = <ThrowOnError extends boolean = false>(
  ...
  return (options?.client ?? client).get<CheckSettingsFieldResponse2, CheckSettingsFieldError, ThrowOnError>({
    ...options,
...
export const getSubscriptionUsage = <ThrowOnError extends boolean = false>(
  ...
  return (options?.client ?? client).get<GetSubscriptionUsageResponse2, GetSubscriptionUsageError, ThrowOnError>({
    ...options,
...
export const createCheckoutSession = <ThrowOnError extends boolean = false>(
  ...
  return (options?.client ?? client).post<CreateCheckoutSessionResponse2, CreateCheckoutSessionError, ThrowOnError>({
    ...options,
 ...
 */
export const createPortalSession = <ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) => {
  return (options?.client ?? client).post<CreatePortalSessionResponse2, CreatePortalSessionError, ThrowOnError>({
    ...options,
...
export const multiLingualWebSearch = <ThrowOnError extends boolean = false>(
  ...
  return (options?.client ?? client).post<MultiLingualWebSearchResponse2, MultiLingualWebSearchError, ThrowOnError>({
    ...options,
 ...
 */
export const serveStatic = <ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) => {
