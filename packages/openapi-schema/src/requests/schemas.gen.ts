...
export const StorageUsageMeterSchema = {
    type: 'object',
    required: ['meterId', 'uid', 'objectStorageQuota', 'resourceSize', 'canvasSize', 'fileSize', 'vectorStorageQuota', 'vectorStorageUsed'],
    properties: {
        meterId: {
            type: 'string',
...
export const SelectionKeySchema = {
    type: 'string',
    enum: ['canvasSelection', 'resourceSelection', 'extensionWeblinkSelection', 'canvasCursorSelection', 'canvasBeforeCursorSelection', 'canvasAfterCursorSelection']
} as const;
