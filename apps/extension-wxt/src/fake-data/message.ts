export const fakeRetrievalDocs = [
  ...
  },
  {
    ...
    metadata: {
      title: 'lepton search',
      source: 'https://github.com/leptonai/search_with_lepton',
      loc: {
        lines: {
          from: 2569,
          to: 2613,
  ...
  },
  {
    ...
    metadata: {
      title: 'react router',
      source: 'https://reactrouter.com/en/main/start/tutorial#url-params-in-loaders',
      loc: {
        lines: {
          from: 645,
          to: 724,
...
export const fakeMessages = [
  {
    msgId: 'msg:4e5fb7a580ad24f8ddf0cfcd8b93cddb',
    itemType: 'question',
    type: 'human',
    content: 'agent 是什么？',
  ...
  {
    msgId: 'msg:1702b1adf87e99835da58c6fd7a3ca9d',
    convId: 'conv:b03cb1669896628aac3ef97d2a5eb1b2',
    itemType: 'reply',
    summary: '',
    type: 'ai',
    ...
    relatedQuestions: [
      '在人工智能领域，Agent 的作用是什么？',
      'Agent 技术如何改变人类生活方式？',
      '如何使用 Agent 进行决策和执行任务？',
    ],
  },
  {
    msgId: 'msg:4e5fb7a580ad24f8ddf0cfc1212b93cddb',
    itemType: 'question',
    type: 'human',
    content: 'agent 是什么？',
    convId: 'conv:b03cb1669896628aac3ef97d2a5eb1b2',
  ...
  {
    msgId: 'msg:1702b1adf87e99835da58c6fd12127a3ca9d',
    convId: 'conv:b03cb1669896628aac3ef97d2a5eb1b2',
    itemType: 'reply',
    summary: '',
    type: 'ai',
    content:
      'Agent 是指一种程序或系统，可以自主执行特定任务或代表用户执行任务的实体。在这种情境下，agent 是指一个由 LLM 控制的虚拟角色，可以在模拟环境中执行各种任务和与其他 agent 互动。',
    questionId: 'msg:4e5fb7a580ad24f812120cfcd8b93cddb',
    sources: fakeRetrievalDocs,
    relatedQuestions: [
      '在人工智能领域，Agent 的作用是什么？',
      'Agent 技术如何改变人类生活方式？',
  ...
  {
    msgId: 'msg:4e5fb7a580ad24f8ddf0cfcd8b931212cddb',
    itemType: 'question',
    type: 'human',
    content: 'agent 是什么？',
    convId: 'conv:b03cb1669896628aac3ef97d2a5eb1b2',
