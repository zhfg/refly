  ...
  const fetchData = async (currentPage = 1) => {
    try {
      ...
      if (!threadStore?.hasMore && currentPage !== 1) {
        setScrollLoading(
          <span>{t("translation:threadLibrary.footer.noMoreText")}</span>,
        )
        return
      }
      ...
      message.error(t("translation:threadLibrary.list.fetchErr"))
    } finally {
  ...
  return (
    <div
      ...
      <List
        ...
        bordered={false}
        header={
          <p className="thread-library-title">
            {t("translation:threadLibrary.title")}
          </p>
        }
        pagination={false}
        offsetBottom={50}
        ...
        noDataElement={
          <div>{t("translation:threadLibrary.list.fetchErr")}</div>
        }
            ...
            actions={[
              <span
                ...
                <span
                  ...
                  {t("translation:threadLibrary.item.askFollow")}
                </span>
              </span>,
              <span key={2}>
              ...
              <span key={3}>
                ...
                <span
                  ...
                  {t("translation:threadLibrary.item.messageCount", "", {
