        ...
        <div className="relative pb-10 pt-32 md:pb-16 md:pt-24">
          ...
          <div className="relative mt-6 flex justify-center overflow-hidden sm:mt-10">
            <div
              ...
              <div className="absolute inset-0 z-10 rounded-md bg-black/30 transition-opacity duration-200 group-hover:opacity-50" />

              <div className="absolute left-1/2 top-1/2 z-20 -translate-x-1/2 -translate-y-1/2 transform">
                <MdOutlinePlayCircleFilled className="h-16 w-16 text-white opacity-90 transition-all duration-200 group-hover:scale-110 group-hover:opacity-100" />
              </div>
              <BlurImage
