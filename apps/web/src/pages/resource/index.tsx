...
// 自定义组件
import { KnowledgeBaseDirectory } from "@refly-packages/ai-workspace-common/components/knowledge-base/directory"
import { KnowledgeBaseResourceDetail } from "@refly-packages/ai-workspace-common/components/knowledge-base/resource-detail"
import { KnowledgeBaseDetailEmpty } from "@refly-packages/ai-workspace-common/components/knowledge-base/knowledge-base-detail-empty"
// 样式
import "./index.scss"
import {
  ActionSource,
...
const Resource = () => {
  ...
  const { tabs, activeTab, setActiveTab, handleDeleteTab } =
    useKnowledgeBaseTabs()
  ...
  if (
    (!resId || resId === "undefined" || resId === "null") &&
    (!kbId || kbId === "undefined" || kbId === "null")
  ) {
          ...
          return (
            <div className="knowledge-base-detail-header">
              ...
              <div className="knowledge-base-detail-navigation-bar">
                <Tooltip
                  content={t(
                    "knowledgeBase.header.searchAndOpenResourceOrCollection",
                  )}>
                  <Button
                    icon={<IconSearch />}
                    type="text"
                    ...
                    onClick={() => {
                      searchStore.setPages(
                        searchStore.pages.concat("readResources"),
                      )
