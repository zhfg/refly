...
import { IconCopy, IconNotificationClose, IconPalette, IconPlus, IconQuote, IconReply, IconShareExternal, IconShareInternal, IconTranslate } from '@arco-design/web-react/icon';
                                ...
                                <div className="session-source-list">
                                    <List
                                        ...
                                        render={(item, index) => (
                                            <List.Item
                                                key={index}
                                                style={{ borderBottom: '0.5px solid var(--color-fill-3)' }}
                                            ...
                                            >
                                                <List.Item.Meta
                                                    title={<a href={item.metadata?.source}><span style={{ fontSize: 12, color: 'rgba(0, 0, 0, .8)', fontWeight: 'bold' }}>{item.metadata?.title}</span></a>}
                                                    description={<Typography.Paragraph ellipsis={{ rows: 1, wrapper: 'span' }} style={{ fontSize: 10, color: 'rgba(0, 0, 0, .8)' }}>
                                                        {item.pageContent}
                                                    </Typography.Paragraph>}
                                                />
                                            </List.Item>
